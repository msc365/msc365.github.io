...
<div class="tip">
    <p><strong>Tip</strong>: Feel free to copy/paste the following guidelines into a <strong>CONTRIBUTING</strong> file and save it into the root directory of your project.</p>
</div>
